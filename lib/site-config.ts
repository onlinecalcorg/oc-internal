...
export const calculatorCategories: CalculatorCategory[] = [
  ...
  // Other categories remain the same, just updating the first one for brevity
  {
    ...
    calculators: [
      ...
      ,
      {
        ...
        seoDescription:
          "Determine the financial and performance benefits of upgrading to 5G in 2025. Evaluate ROI, productivity gains, and cost-effectiveness for your organization.",
        yearUpdated: "2025",
        keywords: [
      ...
      ,
      {
        ...
        seoDescription:
          "Calculate the ROI and implementation costs of AI solutions in 2025. Discover how artificial intelligence can streamline operations and boost profitability.",
        yearUpdated: "2025",
        keywords: [
  ...
  // Other categories remain the same
  {
    ...
    description: "Evaluate the costs and benefits of modern technology investments with AI-powered tools",
    slug: "technology",
    icon: "cpu",
    calculators: [
      {
      ...
      {
        title: "AI Calculator",
        description: "Smart math assistant powered by AI for complex calculations and explanations",
        slug: "ai-calculator",
        category: "technology",
        icon: "sparkles",
        seoTitle: "AI Calculator 2025 | Smart Math Assistant with ChatGPT Interface",
        seoDescription:
          "Get instant help with calculations using our AI-powered calculator. Ask questions, solve complex problems, and get step-by-step explanations.",
        yearUpdated: "2025",
        keywords: [
          "AI calculator",
          "smart calculator",
    ...
    calculators: [
      {
        ...
        seoDescription:
          "Assess your mental health with our 2025 tool. Get recommendations and insights into stress, anxiety, and overall wellbeing based on your responses.",
        yearUpdated: "2025",
        keywords: [
      ...
      },
      {
        ...
        seoDescription:
          "Calculate your ideal nutrition needs with our 2025 calculator. Get personalized daily calorie, protein, fat, and carb targets based on your profile.",
        yearUpdated: "2025",
        keywords: [
      ...
      },
      {
        ...
        seoDescription:
          "Use our 2025 BMI calculator to measure your body mass index and interpret the results to understand your health status and weight category.",
        yearUpdated: "2025",
        keywords: [
          "BMI calculator 2025",
